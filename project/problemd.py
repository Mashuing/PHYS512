# -*- coding: utf-8 -*-
"""
Created on Thu Dec 17 01:37:29 2020
...
a=0
position = []
f= open('D:\git_code\PHYS512\project\ps_c_periodic\position.npy','ab')
ener = []
time = []
...
for t in range(200):
     ...
     if t%oversample==0:
         ...
         fig.savefig('D:/git_code/PHYS512/project/ps_c_periodic/'+'bla'+str(t)+'.png', dpi=600)
         
                
         plt.pause(0.001)
     np.savetxt('D:\git_code\PHYS512\project\ps_c_periodic\Energy.txt',ener)
     x_tmp= x
     v_tmp = v
